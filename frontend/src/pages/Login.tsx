...
import { FloatingOrbs, MoroccanPattern } from "@/components/decorative/MoroccanElements";
          ...
          <Card variant="glass" className="animate-scale-in">
            <CardHeader className="text-center pb-2">
              <div className="flex justify-center mb-4">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary to-moroccan-blue-light flex items-center justify-center animate-pulse-glow">
                  <TrendingUp className="w-8 h-8 text-primary-foreground" />
                </div>
              </div>
              <CardTitle className="text-2xl">Welcome Back</CardTitle>
              <CardDescription>
                Sign in to access your credit risk dashboard
              </CardDescription>
            </CardHeader>
